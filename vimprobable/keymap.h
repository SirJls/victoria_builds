...
Key keys[] = {
    ...
    { 0,                    0,              GDK_u,          revive,     {} },
        ...
        /* custom commands */
    { 0,                    GDK_g,          GDK_b,          input,      {.s = ":tabopen https://github.com/git-jls" } },
    ...
    { 0,                    GDK_g,          GDK_w,          input,      {.s = ":tabopen http://sjorssparreboom.nl" } },
    { 0,                    GDK_g,          GDK_p,          input,      {.s = ":tabopen http://project.dev" } },
    { 0,                    GDK_g,          GDK_r,          input,      {.s = ":tabopen https://www.inoreader.com/" } },
    { 0,                    GDK_g,          GDK_s,          input,      {.s = ":tabopen https://stackoverflow.com" } },
    { 0,                    0,              GDK_x,          quit,       {0} },
